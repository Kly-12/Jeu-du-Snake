...
Il faut avoir trois fichiers et un navigateur web. Pour les fichiers, il faut un fichier HTML, par exemple index.html, un fichier CSS, par exemple style.css et un fichier JavaScript, par exemple script.js. Ensuite il faut sauvegarder tous les fichiers dans un même dossier. Il faut aller sur GitHub pour avoir les fichiers avec les codes. Puis il faut ouvrir le projet dans un navigateur web. 
